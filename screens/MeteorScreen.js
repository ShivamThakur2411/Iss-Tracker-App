...
import { Text, View, SafeAreaView, FlatList, ImageBackground, Platform, Dimensions, StyleSheet, Image, StatusBar } from 'react-native';
...
export default class MeteorScreen extends React.Component{
    ...
    getMeteor=()=>{
        axios.get('http://www.neowsapp.com/rest/v1/neo/2277810?api_key=D7X5LDGU68DDX1HNASAARX15G6NDCEIGOOCVSQXZ')
        .then(response=>{
            this.setState({
...
const styles = StyleSheet.create({ 
    ...
    backgroundImage: { 
        flex: 1, resizeMode: 'cover', width: Dimensions.get('window').width, height: Dimensions.get('window').height 
        }, 
    titleBar: { 
    ...
    titleText: { 
     ...
     listContainer: {
          backgroundColor: 'rgba(52, 52, 52, 0.5)', 
            justifyContent: "center", marginLeft: 10, marginRight: 10, marginTop: 5, borderRadius: 10, padding: 10 
        }, 
     cardTitle: { 
